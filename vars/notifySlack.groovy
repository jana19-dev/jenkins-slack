 ...
 */
def call(Boolean errorOccurred = null, String channel = '#general', String commitMessage = "", String author = "") {
  ...
  if (errorOccurred == null) {
    ...
    attachments = buildFailureMessage(commitMessage, author, errorOccurred)
  }
